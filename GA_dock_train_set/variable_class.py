class variables:
    ...
    def __init__(self, parameter_file, box_size,  scale_factor, metal_symbol, metal_cap, num_generations, num_parents_mating, sol_per_pop, parent_selection_type, keep_parents, k_tournament, crossover_type, 
