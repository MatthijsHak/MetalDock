...
vdw_r = {'H': 1.20, 'HE': 1.20,
         ...
         'P': 1.80, 'S': 1.75, 'CL': 1.70, 'ZN': 1.39,'RU': 2.05,'I': 2.36}
...
def vdw_surface(coordinates, elements, scale_factor):
    ...
    for i in range(len(coordinates)):
        # calculate approximate number of ESP grid points - surface area sphere
